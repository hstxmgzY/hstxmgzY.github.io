...
![1.png](Chp3.assets/5bc722b068e48.png)
...
![2.png](Chp3.assets/5bc722b0ccec4.png)

（2）当输入属性有多个的时候，例如对于一个样本有d个属性{（x1,x2...xd）,y}，则y=wx+b需要写成：

![0.png](Chp3.assets/5bc72567b8bcd.png)

通常对于多元问题，常常使用矩阵的形式来表示数据。在本问题中，将具有m个样本的数据集表示成矩阵X，将系数w与b合并成一个列向量，这样每个样本的预测值以及所有样本的均方误差最小化就可以写成下面的形式：

![3.png](Chp3.assets/5bc722b0ad8f7.png)

![4.png](Chp3.assets/5bc722b0af652.png)

![5.png](Chp3.assets/5bc722b090543.png)
...
![6.png](Chp3.assets/5bc722b0cde33.png)
...
![9.png](Chp3.assets/5bc722b0c7748.png)

![10.png](Chp3.assets/5bc722b0a655d.png)
...
![11.png](Chp3.assets/5bc723b824f0c.png)

![12.png](Chp3.assets/5bc723b817961.png)
...
![13.png](Chp3.assets/5bc723b863ebb.png)![14.png](Chp3.assets/5bc723b85bfa9.png)

想让同类样本点的投影点尽可能接近，不同类样本点投影之间尽可能远，即：让各类的协方差之和尽可能小，不用类之间中心的距离尽可能大。基于这样的考虑，LDA定义了两个散度矩阵。

+ 类内散度矩阵（within-class scatter matrix）

![15.png](Chp3.assets/5bc723b8156e1.png)

+ 类间散度矩阵(between-class scaltter matrix)

![16.png](Chp3.assets/5bc723b7e9db3.png)

因此得到了LDA的最大化目标：“广义瑞利商”（generalized Rayleigh quotient）。

![17.png](Chp3.assets/5bc723b7e8a61.png)

从而分类问题转化为最优化求解w的问题，当求解出w后，对新的样本进行分类时，只需将该样本点投影到这条直线上，根据与各个类别的中心值进行比较，从而判定出新样本与哪个类别距离最近。求解w的方法如下所示，使用的方法为λ乘子。

![18.png](Chp3.assets/5bc723b83d5e0.png)
...
![19.png](Chp3.assets/5bc723b862bfb.png)

![20.png](Chp3.assets/5bc723b8300d5.png)
...
3.  直接基于原数据集进行学习，对预测值进行“再缩放”处理。其中再缩放也是代价敏感学习的基础。![21.png](Chp3.assets/5bc726fe87ae2.png)
